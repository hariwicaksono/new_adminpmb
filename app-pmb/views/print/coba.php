...
<html>
	...
	<div id="container">	
		<div class="header">
			<div class="logo2">
				<img src="<?php echo base_url();?>image/kop_atas.jpg" style="width: 30%;margin-top: 10px;padding-left: 10px;margin-bottom: 0px;" />
				...
				<br />
				&nbsp;&nbsp;<font style="font-size:10px;">Jl. Letjend Pol Sumarto Watumas Purwanegara, PURWOKERTO, Kode Pos : 53131, Telp : (0281)623321</font>
			</div>
