...
'borders' => array(
  ...
  $objPHPExcel->getActiveSheet()->getStyle('B7:E7')->applyFromArray($styleArray2);
	...
	$worksheet = $objPHPExcel->getActiveSheet();
		...
		foreach($datamhs as $row){
			...
			$worksheet
					...
					->setCellValueByColumnAndRow($column+4,$i+7,$row['telp'])
					;
			$styleArray4 =array(
				'fill' => array(
				'type' => PHPExcel_Style_Fill::FILL_SOLID
			...
			$worksheet->getStyle('B'.$merge.':E'.$merge)->applyFromArray($styleArray4);
		$i++;
            ...
            header('Content-Disposition: attachment;filename="Laporan_akun.xls"');
				ob_end_clean();
            //unduh file
